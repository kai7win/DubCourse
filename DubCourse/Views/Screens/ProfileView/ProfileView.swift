    ...
    var body: some View {
        ...
        ZStack{
            VStack {
                ...
                Button {
                    viewModel.profileContent == .create ? viewModel.createProfile() : viewModel.updateProfile()
                } label: {
                    DDGButton(title: viewModel.profileContent == .create ? "Create Profile" : "Upate Profile")
                }
                .padding(.bottom)
